...
T.Slider {
    ...
    background: Rectangle {
        ...
        color: control.enabled ? Color.transparent(control.MaterialYou.foregroundColor, 0.33) : MaterialYou.color(MaterialYou.OnSurface)
        ...
        Rectangle {
            ...
            color: control.enabled ? control.MaterialYou.foregroundColor : MaterialYou.color(MaterialYou.OnSurface)
        }
    }
}
