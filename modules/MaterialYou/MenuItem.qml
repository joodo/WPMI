...
T.MenuItem {
    ...
    icon.width: 24
    icon.height: 24
    icon.color: control.enabled ? MaterialYou.foregroundColor : MaterialYou.color(MaterialYou.OnSurface)
    ...
    background: Rectangle {
        ...
        opacity: control.highlighted ? 0.08 : 0
    }
}
