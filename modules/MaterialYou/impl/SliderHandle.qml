...
Item {
    ...
    Rectangle {
        ...
        color: root.control.enabled ? root.control.MaterialYou.foregroundColor : MaterialYou.color(MaterialYou.OnSurface)
    ...
    Ripple {
        ...
        color: Color.transparent(root.control.MaterialYou.foregroundColor, 0.15)
    }
}
